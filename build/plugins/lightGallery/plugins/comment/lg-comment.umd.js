...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.lgComment = factory());
})(void 0, function () {
  'use strict';
  ...
  ***************************************************************************** */
  ...
  var CommentBox = /** @class */function () {
    function CommentBox(instance, $LG) {
      ...
      this.settings = _assign(_assign({}, commentSettings), this.core.settings);
      return this;
    }

...
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).lgComment = e();
}(void 0, function () {
  "use strict";
  ...
  return function () {
    function i(e, o) {
      return this.core = e, this.$LG = o, this.settings = _t(_t({}, n), this.core.settings), this;
    }
    return i.prototype.init = function () {
      ...
      var t = '<button type="button" aria-label="' + this.settings.commentPluginStrings.toggleComments + '" class="lg-comment-toggle lg-icon"></button>';
      ...
      n.remove(), this.core.outer.find(".lg-comment-body").append('<div id="disqus_thread"></div>'), this.core.LGel.on(e + ".comment", function () {
        n.html("");
          ...
          try {
            DISQUS.reset({
              ...
              config: function config() {
                this.page.identifier = n.core.galleryItems[o].disqusIdentifier, this.page.url = n.core.galleryItems[o].disqusURL, this.page.title = n.settings.disqusConfig.title, this.language = n.settings.disqusConfig.language;
              }
            });
          } catch (t) {
